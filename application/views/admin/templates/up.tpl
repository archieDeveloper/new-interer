...
<head>
  ...
  {foreach from=$include_js item=js_path}
    <script type="text/javascript" src="/js/{$js_path}.js"></script>
  {/foreach}
  {foreach from=$include_css item=css_path}
      ...
      <div class="left-aside">
        ...
        <ul>
          ...
          <li {(!empty($page_controller) && $page_controller == 'portfolio') ? 'class="active"' : ''}>
            ...
            <ul>
              <li {(!empty($page_controller) && empty($page_action) && $page_controller == 'portfolio') ? 'class="active"' : ''}><a href="/nimyadmin/portfolio.html">Все работы</a></li>
              <li {(!empty($page_controller) && $page_controller == 'portfolio' && !empty($page_action) && $page_action == 'add') ? 'class="active"' : ''}><a href="/nimyadmin/portfolio/add.html">Добавить новую</a></li>
              <li {(!empty($page_controller) && $page_controller == 'portfolio' && !empty($page_action) && $page_action == 'categories') ? 'class="active"' : ''}><a href="/nimyadmin/portfolio/categories.html">Категории</a></li>
            </ul>
          </li>
          <li {(!empty($page_controller) && $page_controller == 'articles') ? 'class="active"' : ''}>
            <a href="/nimyadmin/articles.html">Статьи</a>
            <ul>
              <li {(!empty($page_controller) && empty($page_action) && $page_controller == 'articles') ? 'class="active"' : ''}><a href="/nimyadmin/articles.html">Все статьи</a></li>
              <li {(!empty($page_controller) && $page_controller == 'articles' && !empty($page_action) && $page_action == 'add') ? 'class="active"' : ''}><a href="/nimyadmin/articles/add.html">Добавить новую</a></li>
            </ul>
          </li>
