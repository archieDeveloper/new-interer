                ...
                <ul>
                    ...
                    <li <?php echo !empty($page_controller) && $page_controller == 'portfolio' ? 'class="active"' : ''; ?>>
                      ...
                      <ul>
                        ...
                        <li <?php echo !empty($page_action) && $page_action == 'add' ? 'class="active"' : ''; ?>><a href="/nimyadmin/portfolio/add.html">Добавить новую</a></li>
                        <li <?php echo !empty($page_action) && $page_action == 'categories' ? 'class="active"' : ''; ?>><a href="/nimyadmin/portfolio/categories.html">Категории</a></li>
                      </ul>
                    </li>
                    <li><a href="/nimyadmin/articles.html">Статьи</a></li>
