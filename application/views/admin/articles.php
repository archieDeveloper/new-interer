...
<?php if ($_GET['page'] == 1) : ?>
<div class="add-block">
    <span class="button green btn-new-art">
        <i class="flaticon-plus13"></i> Добавить статью
    </span>
    <div id="error"></div>
    <ul id="new-articles-box" class="list-page">
        <li>
            ...
            <a class="button fr btn-no-new-art" href="#"><i class="flaticon-cross5"></i> Отменить</a>
