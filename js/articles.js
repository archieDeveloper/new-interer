    ...
    $(document).on('click','.del-art', function(e){
        ...
        $.ajax({
            ...
            success  : function(data){
                ...
                $_this.parent().parent().before('<li class="news-trash">Статья удалена. <a href="#" class="no-trash" data-id="'+$id+'">Восстановить</a><a class="button close-no-trash" href="javascript:void(0);"><i class="flaticon-cross5"></i></a></li>');
