$(document).ready(function(){
    ...
    $('#fileupload').fileupload({
        ...
        progressall: function (e, data) {
            ...
            if(data.result.error != undefined){
                ...
                console.log(data);
                $('#error').hide();
                $newFileListPage = $($listPageLi).clone().prependTo('#files').removeAttr('id');
    ...
    $(document).on('click','.drop li',function(){
        ...
        $save = $(this).parent().prev().find('.status-field-save');
        $save.show();
